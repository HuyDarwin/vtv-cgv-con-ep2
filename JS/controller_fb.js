	...
	(function (con) {
		...
		$('#loadvt').click(function(){
			...
			if($("#round_select option:selected").val() == '4_2'){
				...
				rs += "<button class='autoname' id='rc4_2_obj7' disabled>Đúng (Đ) (TĐ)</button>"
				rs += "<button class='autoname' id='rc4_2_obj8' disabled>Đúng (P) (TĐ)</button>"
				rs += "<button class='autoname' id='rc4_2_obj9' disabled>Sai (TĐ)</button>"
				rs += "<button class='autoname' id='rc4_2_obj10' disabled>Đúng (Đ) (TV)</button>"
				rs += "<button class='autoname' id='rc4_2_obj11' disabled>Đúng (P) (TV)</button>"
				rs += "<button class='autoname' id='rc4_2_obj12' disabled>Sai (TV)</button>"
				rs += "</div>"
			...
			$('#rc4_2_obj6').click(function(){
				...
				$('#rc4_2_obj7, #rc4_2_obj8, #rc4_2_obj9, #rc4_2_obj10, #rc4_2_obj11, #rc4_2_obj12').removeAttr("disabled");
			})
			$('#rc4_2_obj7').click(function(){
				con.CongDiemNguoiChoi(1,false);
			})
			...
			$('#rc4_2_obj4').click(function(){
				...
				$('#rc4_2_obj4, #rc4_2_obj5, #rc4_2_obj6, #rc4_2_obj7, #rc4_2_obj8, #rc4_2_obj9, #rc4_2_obj10, #rc4_2_obj11, #rc4_2_obj12').attr("disabled", true);
			})
